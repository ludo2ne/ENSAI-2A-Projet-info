...
- **A need** :arrow_right: Why are we doing it?
- **A scope** :arrow_right: What are we going to deliver?
- **People** :arrow_right: Who is involved?
- **Resources** :arrow_right: What do we need?
- **Constraints** :arrow_right: How much time? How much money?
- **Quality** :arrow_right: What level of quality is expected?

:::{.notes}
A project is a balance between three main constraints:

- **Scope** — What do we deliver?
- **Time** — When must it be delivered?
- **Cost** — What resources do we have?
:::
...
- **_DAO (Data Access Object):_**
  - The part of your code that communicates with the database (Lecture 4/Practical 3)
- **_Service:_**
  - Business code
  - Manipulates business objects to create information or value
  - Requests objects from the DAO layer (Practical 3)
  - Calls external web services (Practical 4)

...
### Repository Structure (Root) {.smaller}
...
- backend -> API (voir ci-après)
- frontend -> Interface (voir TP5)
:::


### Repository Structure (Backend) {.smaller}
...
![](img/quality-doc-commitstrip.jpg){width="50%"}
...
:::{.notes}
README qui veut dire ...

Un bon README = vos grands-parents sont capables de lancer l'appli

markdown : balisage (quarto, notebook)
:::

...
Phases d'un projet : Analyse besoin, Cahier charges, Analyse fonctionnelle, dev, tests, livraison
:::
...
- Data : gère le stockage. Plus de détails dans quelques minutes

...
:::{.notes}
Expliquer brievement le contexte, car dao/service c'est encore nouveau.
...
:::{.notes}
Autre exemple (fin du TP3), mock DAO: tests sur un schéma dédié et pas sur les données de PROD.
:::
...
❌ puis ✅ Temps -> Prend du temps au début mais gain de temps à long terme
:::

...
format: 
  html: default
  revealjs:
    footer: "[Home](../../index.html) --- [Git](03-git.html)"
    output-file: 03-git-slides.html
---
...
- [GitHub's guides](https://guides.github.com/){target="_blank"}
- [Atlassian's Git tutorials](https://www.atlassian.com/git/tutorials){target="_blank"}
- [ENSAI-tools](https://ludo2ne.github.io/ENSAI-tools/doc/git/presentation.html){target="_blank"}
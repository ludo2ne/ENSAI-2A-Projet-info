...
Pour résumer en quelques mots, il y aura des *Pokemons* qui s'affronteront lors de *Battles* en lançant des *Attacks*. Voici les principaux objets que vous allez manipuler :
...
- `Battle` : servira à faire s'affronter 2 Pokémons pour déterminer l'issue du combat (partie 4)

Et voici un diagramme de classe très simplifié des classes principales à coder lors de ces quatres TP.
...
:construction: Déplacer dans un autre TP

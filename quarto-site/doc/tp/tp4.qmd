...
- [ ] Launch a [**customised**]{.underline} VSCode service
  - See [Datalab page](../outils/datalab.qmd){target="_blank"}
...
You must connect to the original repository (upstream) to retrieve the branch:

- [ ] `git remote add upstream https://github.com/ludo2ne/ENSAI-2A-complement-info-TP.git`
- [ ] `git remote -v` to list the remote repositories associated with your local repo
- [ ] `git fetch upstream` to get all branches
- [ ] `git switch -c tp4-base upstream/tp4-base` create branch from upstream/tp4-base
- [ ] `git push origin tp4-base` push to your fork
:::

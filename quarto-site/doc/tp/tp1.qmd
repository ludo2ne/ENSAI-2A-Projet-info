...
- [ ] Après être revenu à l'accueil, choisissez `Se connecter`
  ...
  - :bulb: pour aller plus vite, vous pouvez utiliser l'utilsateur « a », mot de passe « a »
...
- [ ] Faîtes en sorte que ce fichier reste dans votre dépôt local sans être envoyé sur GitHub

...
- [ ] Cloner le dépôt ci-dessous
  - `git clone https://github.com/ludo2ne/ENSAI-2A-projet-info-template`
- [ ] Suivez les instructions du README pour installer et lancer l'application
  - Packages à installer
  - Variables d'environnement

2 types d'applications peuvent vous être demander en projet :

- une application de Menu
  - l'utilisateur navigue dans des menus
- un webservice
  - l'application expose des endpoints
  - l'utilisateur peut interroger ces endpoints

### Une application de Menu

- [ ] lancez le *__main__*

Vous arrivez sur le menu d'accueil. Le principe d'une application est de vous faire naviguer d'un menu à l'autre tout en effectuant des opérations en arrière plan.

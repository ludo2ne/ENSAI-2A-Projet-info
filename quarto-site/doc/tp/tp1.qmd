...
- [ ] Follow these [instructions](https://ludo2ne.github.io/ENSAI-tools/doc/datalab/vscode-python.html#ia-agent){target="_blank"} to **set up** AI agent.
...
- [ ] Select *Open the service in the clone folder*
...
> Example of link: <https://datalab.sspcloud.fr/launcher/ide/vscode-python?name=vscode-python&version=2.5.7&s3=default&init.personalInit=%C2%ABhttps%3A%2F%2Fraw.githubusercontent.com%2Fludo2ne%2FENSAI-2A-projet-info-template%2Frefs%2Fheads%2Fmain%2Fonyxia_setup.sh%C2%BB&git.repository=%C2%ABhttps%3A%2F%2Fgithub.com%2Fludo2ne%2FENSAI-2A-projet-info-template.git%C2%BB&networking.user.enabled=true&networking.user.ports[1]=8000>{target="_blank"}
...
:::{.notes}
TODO simplement parler de code 200, 400 ou 500 et détailler au TP4
:::

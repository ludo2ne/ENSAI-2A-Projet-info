...
::: {.callout-note title="Old Labs"}
2025 and before:

- Lab1: current file
- [Lab2: Python, OOP, Unit Tests and Documentation](./tp2.qmd)
- [Lab3: Web Services and Data Formats](./tp3.qmd)
- [Lab4: Data Access Objet (DAO)](./tp4.qmd)
:::
...
- [ ] Creates a remote repository on GitHub ([new Repository](https://github.com/new){target="_blank"})
  - Repository name: for example `Projet-info-2A-equipe-<team_number>`.

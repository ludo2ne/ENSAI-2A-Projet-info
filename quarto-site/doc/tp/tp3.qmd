...
::: {.callout-important title="Avant de commencer"}
...
::: {.callout-note}
**Webservice** : le terme webservice est un terme vaste et il serait compliqué d'en donner une définition courte ([article wikipedia](https://en.wikipedia.org/wiki/Web_service)).

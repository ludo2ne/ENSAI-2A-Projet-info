...
- [SSPCloud](https://datalab.sspcloud.fr/launcher/ide/vscode-python?name=vscode-python&version=2.5.3&s3=region-79669f20&persistence.size=«2Gi»&init.personalInit=«https%3A%2F%2Fraw.githubusercontent.com%2Fludo2ne%2FENSAI-2A-Projet-info%2Frefs%2Fheads%2Fmain%2Fscripts%2Fonyxia_setup.sh»&networking.user.enabled=true&networking.user.ports[1]=8000&autoLaunch=true){target="_blank"}

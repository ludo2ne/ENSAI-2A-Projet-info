...
:construction: Update service version and script
...
- [SSPCloud](https://datalab.sspcloud.fr/launcher/ide/vscode-python?name=vscode-python&version=2.5.6&s3=region-79669f20&init.personalInit=«https%3A%2F%2Fraw.githubusercontent.com%2Fludo2ne%2FENSAI-2A-projet-info-template%2Frefs%2Fheads%2Fmain%2Fonyxia_setup.sh»&networking.user.enabled=true&networking.user.ports[1]=8000&autoLaunch=true){target="_blank"}
- [GENES Datalab](https://onyxia.lab.groupe-genes.fr/launcher/ide/vscode-python?name=vscode-python&version=2.3.19&s3=region-46d082f3&init.personalInit=«https%3A%2F%2Fraw.githubusercontent.com%2Fludo2ne%2FENSAI-2A-Projet-info%2Frefs%2Fheads%2Fmain%2Fscripts%2Finit-vscode.sh»&networking.user.enabled=true&networking.user.port=9876&autoLaunch=true){target="_blank"} :construction:
:::

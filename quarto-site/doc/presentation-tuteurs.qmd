...
description: "[Slides](presentation-tuteurs-slide.html)"
...
format:
  ...
  revealjs:
    ...
    slide-level: 3
    controls: true
    output-file: presentation-tuteurs-slide.html
from: markdown+emoji
...
Le cours de [compléments d'informatique](https://ludo2ne.github.io/ENSAI-2A-complement-info/){target="_blank"} vise à fournir aux élèves les outils pour mener à bien le projet informatique.

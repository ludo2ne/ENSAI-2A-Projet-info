...
description: "[Slides](presentation-eleves-slide.html)"
...
format:
  ...
  revealjs:
    ...
    slide-level: 3
    controls: true
    output-file: presentation-eleves-slide.html
from: markdown+emoji
...
- Esprit d'équipe
- Prévenir dès que possible si ça va pas
...
- À remplir chaque semaine
  - au plus tard le vendredi à 18h

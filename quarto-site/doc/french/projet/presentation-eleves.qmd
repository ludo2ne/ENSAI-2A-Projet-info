...
- fichier init.sql et pop.sql + reset_database

Backend : coeur de l'appli à soigner

Frontend : si besoin, code non évalué

API externe : 

- Données statiques, dynamiques ? Quand requeter ? 
...
| mar-jeu 3-5 novembre        | 3 jours d'immersion (Suivi 5-6)               |
...
- Notez vos questions (Réflechissez aux réponses : Plan A, plan B)

Profitez de chaque séance de suivi pour préparer et poser des questions
...
:::{.notes}
UML : Attention à ne pas trop surcharger (valider avec tuteur)
...
- Focalisez-vous sur les fonctionnalités intéressantes
- Citez-vos figures
- Relisez-vous !
- :bulb: Utilisez Typst avec Quarto

:::{.notes}
Pas forcément bien de faire plus de 25 pages.

Note individuelle

Soutenance 20 min :

- jury bienveillant mais différents
- donnez de la personnalité à votre démo
- Testez avant, Presentez-vous, Numérotez, Diapo lisibles, intro, conclusion
- Pas gestion user
:::
